...
void
save_colarray_blob(shared_ptr<test_columns_array_blob>& ptr, shared_ptr<D::Database>& db) {
...
get(const std::string col_name, shared_ptr<test_columns_array_blob>& ptr) {
    long long s = 0;
...
struct ColumnArrayFixtureBlob {

    ColumnArrayFixtureBlob() : id(0) {
        BOOST_REQUIRE_NO_THROW(db = D::Database::create("test_level2"));
        BOOST_REQUIRE_NO_THROW(ptr = test_columns_array_blob::create("column_array_unit_test_0", "test_level2"));
        BOOST_REQUIRE_NO_THROW(
                D::Transaction t = db->begin();
                db->persist(ptr);
                t.commit();
    ...
    void change() {
        BOOST_REQUIRE_NO_THROW(ptr = test_columns_array_blob::create("column__array_unit_test_1", "test_level2"));
        BOOST_REQUIRE_NO_THROW(
                D::Transaction t = db->begin();
                db->persist(ptr);
                t.commit();
    ...
    ~ColumnArrayFixtureBlob() {
    }

    shared_ptr<D::Database> db;
    shared_ptr<test_columns_array_blob> ptr;
    long long id;
};

template<typename T, int Rank>
void
test_case_colArray_blob(
...
BOOST_FIXTURE_TEST_SUITE(column_array_blob_data_unit_tests, ColumnArrayFixtureBlob)

BOOST_AUTO_TEST_CASE(conversion_exceptions_col_array_blob) {
...
BOOST_AUTO_TEST_CASE(column_byte_col_array_blob) {
    char b0[] = {0, 1, 2, 3, 4, 5};
    ...
    test_case_colArray_blob("column_byte", ptr, db, base, ext);
...
BOOST_AUTO_TEST_CASE(column_short_col_array_blob) {
    ...
    das::DatabaseConfig::database("test_level2").buffered_data(true);
    test_case_colArray_blob("column_int16", ptr, db, base, ext);
...
BOOST_AUTO_TEST_CASE(column_int_col_array_blob) {
    int b0[] = {0, 1, 2, 3, 4, 5};
    int b1[] = {7, 8};
    ...
    das::DatabaseConfig::database("test_level2").buffered_data(true);
    test_case_colArray_blob("column_int32", ptr, db, base, ext);
...
BOOST_AUTO_TEST_CASE(column_long_long_col_array_blob) {
    ...
    das::DatabaseConfig::database("test_level2").buffered_data(true);
    test_case_colArray_blob("column_int64", ptr, db, base, ext);
...
BOOST_AUTO_TEST_CASE(column_float_col_array_blob) {
    float b0[] = {0.12, 3.45};
    float b1[] = {7.56, 80.66};
    ...
    das::DatabaseConfig::database("test_level2").buffered_data(true);
    test_case_colArray_blob("column_float32", ptr, db, base, ext);
...
BOOST_AUTO_TEST_CASE(column_string_col_array_blob) {
...
string01string01string01string01string01string01string01string01string01string01";
    ...
    das::DatabaseConfig::database("test_level2").buffered_data(true);
    test_case_colArray_blob("column_string", ptr, db, base, ext);
...
BOOST_AUTO_TEST_CASE(column_byte_int_col_array_blob) {
    int b0[] = {0, 1, 2, 3, 4, 5};
...
BOOST_AUTO_TEST_CASE(column_float_byte_col_array_blob) {
    char b0[] = {0, 3};
    char b1[] = {7, 66};
    char b2[] = {14, 18};
