        ...
        public:
            ...
            Array<T> operator()(U& native_type) const{
                ...
                if (c_->size() > s_) {
                    ...
                    /* data missing in the file, avoid gaps between data unloaded from file and memory buffer
                     * returning only the data succesfully loaded from file
                     */ 
                    if(count < size)
