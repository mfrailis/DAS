...
public:
    ...
    void operator() (std::list< das::ArrayStore<X> > &vec) const {
        if (elem_.size() > 0)
            vec.push_back(das::ArrayStore<X>(elem_));
    }

    template<typename Y>
    void operator() (std::list< das::ArrayStore<Y> > &vec) const {
    ...
    void operator() (std::list< das::ArrayStore<std::string> > &vec) const {
        throw das::bad_type();
    }
...
public:
    ...
    template<typename T>
    U* operator() (std::list< das::ArrayStore<T> > &vec) {
        typename std::list< das::ArrayStore<T> >::iterator v_it = vec.begin();
    ...
    U* operator() (std::list< das::ArrayStore<std::string> > &vec) {
        return b_;
    }
...
public:
    ...
    std::string* operator() (std::list< das::ArrayStore<std::string> > &vec) {
        std::list< das::ArrayStore<std::string> >::iterator v_it = vec.begin();
        if (v_it == vec.end()) return b_;
        size_t first_offset = 0;
    ...
    template<typename T>
    std::string* operator() (std::list< das::ArrayStore<T> > &vec) {
        return b_;
    }
...
public:
    ...
    template<typename U>
    OutputIterator
    operator() (std::list< das::ArrayStore<U> > &vec) {
        typename std::list< das::ArrayStore<U> >::iterator v_it = vec.begin();
        if (v_it == vec.end()) return b_;
        size_t first_offset = 0;
    ...
    OutputIterator operator() (std::list< das::ArrayStore<std::string> > &vec) {
...
public:
    ...
    OutputIterator 
    operator() (std::list< das::ArrayStore<std::string> > &vec) {
        std::list< das::ArrayStore<std::string> >::iterator v_it = vec.begin();
        if (v_it == vec.end()) return b_;
        size_t first_offset = 0;
